...
parser.add_argument('-data', metavar='DIR',default='./Images',
...
def main():
    ...
    if args.multiprocessing_distributed:
        ...
        #mp.spawn() 第一个参数是一个函数，这个函数将执行训练的所有步骤。从这一步开始，Python 将建立多个进程，每个进程都会执行 main_worker() 函数。
        # 第二个参数是开启的进程数目。第三个参数是传给 main_worker() 的函数实参。
    else:
