...
def student_val(model, device, val_loader, num_class, targetclass_value):
    ...
    print("------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
    print('Student Val:Loss: %.3f  Acc_overall: %.3f%%  Acc_user: %.03f%%  Acc_producer: %.3f%%  MIoU: %.3f%%  Precision: %.3f%%  Recall: %.3f%%  F1-Score: %.3f%%'
    ...
    val_result=np.array([val_loss, (100. * mean_acc_overall / len(val_loader)), (100. * mean_acc_user / len(val_loader)), (100. * mean_acc_producer / len(val_loader)), (100. * mean_mIoU / len(val_loader)), (100. * mean_precision / len(val_loader)), (100. * mean_recall / len(val_loader)), (100. * mean_f1 / len(val_loader))])
