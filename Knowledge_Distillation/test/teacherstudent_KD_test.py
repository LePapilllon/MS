...
def teacherstudent_KD_test(model, device, test_loader, num_class, targetclass_value):
    ...
    print("------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
    print('TeacherStudent_KD Test:Loss: %.3f  Acc_overall: %.3f%%  Acc_user: %.3f%%  Acc_producer: %.3f%%  MIoU: %.3f%%  Precision: %.3f%%  Recall: %.3f%%  F1-Score: %.3f%%'
