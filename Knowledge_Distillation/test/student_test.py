...
def student_test(model, device, test_loader, num_class, targetclass_value):
    ...
    print("------------------------------------------------------------------------------------------------------------------------------------------------------------------------")
    print('Student Test:Loss: %.3f  Acc_overall: %.3f%%  Acc_user: %.3f%%  Acc_producer: %.3f%%  MIoU: %.3f%%  Precision: %.3f%%  Recall: %.3f%%  F1-Score: %.3f%%'
    ...
    test_result=np.array([test_loss, (100. * mean_acc_overall / len(test_loader)), (100. * mean_acc_user / len(test_loader)), (100. * mean_acc_producer / len(test_loader)), (100. * mean_mIoU / len(test_loader)), (100. * mean_precision / len(test_loader)), (100. * mean_recall / len(test_loader)), (100. * mean_f1 / len(test_loader))])
