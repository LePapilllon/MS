...
def resnet50(pretrained=False, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(load_url('https://github.com/bubbliiiing/pspnet-pytorch/releases/download/v1.0/resnet50s-a75c83cf.pth'), strict=False)
        # model.load_state_dict(load_url('checkpoint_1200.pth.tar'), strict=False) # MoCo对比学习1时使用
        # model.load_state_dict(load_url('moco_v2_800ep_pretrain.pth.tar'), strict=False) # MoCo对比学习2时使用
    return model
